...
//            Log.d(MainActivity.LOGAPP, "notifyDataSetChanged called when onChildAdded from routes adapter");
        }
        ...
        public void onChildRemoved(@NonNull DataSnapshot snapshot) {
            ...
            notifyDataSetChanged();
//            Log.d(MainActivity.LOGAPP, "notifyDataSetChanged called when onChildRemoved from routes adapter");
        }
